                ...
                <form name="mbti_form" method="post" action="mbti_question.php">
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="radio" name="plan" value="J" checked> <br>
